...
export const downloadNewUploadSlotInteractor = new DownloadNewUploadSlotInteractor(prisma, uuidService, nodeFileService, zLibcompressionService, santitizerService, environmentConfigService, winstonLoggerService);
