    ...
    try {
      ...
      return Result.success({
        ...
        newSubmission: {
          ...
          submitted: transfer.newSubmission.submitted,
          transferred: transfer.newSubmission.transferred,
          closed: transfer.newSubmission.closed,
          ...
          created: transfer.newSubmission.created,
          modified: transfer.newSubmission.modified,
        },
      });
