...
import { MigrateFeedbackInteractor } from './migrateFeedbackInteractor.js';
...
export const migrateFeedbackInteractor = new MigrateFeedbackInteractor(prisma, uuidService, nodeFileService, environmentConfigService, winstonLoggerService);
