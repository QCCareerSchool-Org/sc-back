...
import type { DeleteNewSubmissionTemplatePricesResponseDTO } from '../../interactors/administrators/deleteNewSubmissionTemplatePricesInteractor.js';
import { deleteNewSubmissionTemplatePricesInteractor } from '../../interactors/administrators/index.js';
...
type Response = DeleteNewSubmissionTemplatePricesResponseDTO;

export class DeleteNewSubmissionTemplatePricesController extends BaseController<Request, Response> {
  ...
  protected async executeImpl({ params, query, privileges }: Request): Promise<void> {
    ...
    const result = await deleteNewSubmissionTemplatePricesInteractor.execute({ courseId, countryId, privileges });
